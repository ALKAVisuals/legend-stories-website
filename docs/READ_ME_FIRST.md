...
There is currently no independently identified source-cleanup step. Follow the exact handling rules in `NEXT_CHAT_HANDOFF_20260905_V2.md`; do not manufacture technical work to bypass a deferred owner/legal/product gate.
